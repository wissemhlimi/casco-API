const es = {
  ...
  entities: {
    produr: {
      errors: {
        unique: {
          produrTitle: 'ProdurTitle debe ser único',
        }
      }
    },
    unit: {
      errors: {
        unique: {
          unitTitle: 'UnitTitle debe ser único',
        }
      }
    },
    family: {
      errors: {
        unique: {
          famTitle: 'FamTitle debe ser único',
        }
      }
    },
    prodline: {
      errors: {
        unique: {
          lineTitle: 'LineTitle debe ser único',
          lineNoper: 'LineNoper debe ser único',
        }
      }
    },
    zap: {
      errors: {
        unique: {
          zapTitle: 'ZapTitle debe ser único',
        }
      }
    },
    linedoc: {
      errors: {
        unique: {
          linedocLink: 'LinedocLink debe ser único',
          linedocType: 'LinedocType debe ser único',
        }
      }
    },
    config: {
      errors: {
        unique: {
          configTitle: 'ConfigTitle debe ser único',
          configRef: 'ConfigRef debe ser único',
        }
      }
    },
    configTable: {
      errors: {
        unique: {
          configCode: 'ConfigCode debe ser único',
        }
      }
    },
    prodtype: {
      errors: {
        unique: {
          prodtypeName: 'ProdtypeName debe ser único',
        }
      }
    },
    product: {
      errors: {
        unique: {
          prodName: 'ProdName debe ser único',
          partNumber: 'PartNumber debe ser único',
        }
      }
    },
    pRODUCTline: {
