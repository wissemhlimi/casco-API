...
const en = {
  ...
  entities: {
    produr: {
      errors: {
        unique: {
          produrTitle: 'ProdurTitle must be unique',
        },
      },
    },
    unit: {
      errors: {
        unique: {
          unitTitle: 'UnitTitle must be unique',
        },
      },
    },
    family: {
      errors: {
        unique: {
          famTitle: 'FamTitle must be unique',
        },
      },
    },
    prodline: {
      errors: {
        unique: {
          lineTitle: 'LineTitle must be unique',
          lineNoper: 'LineNoper must be unique',
        },
      },
    },
    zap: {
      errors: {
        unique: {
          zapTitle: 'ZapTitle must be unique',
        },
      },
    },
    linedoc: {
      errors: {
        unique: {
          linedocLink: 'LinedocLink must be unique',
          linedocType: 'LinedocType must be unique',
        },
      },
    },
    config: {
      errors: {
        unique: {
          configTitle: 'ConfigTitle must be unique',
          configRef: 'ConfigRef must be unique',
        },
      },
    },
    configTable: {
      errors: {
        unique: {
          configCode: 'ConfigCode must be unique',
        },
      },
    },
    prodtype: {
      errors: {
        unique: {
          prodtypeName: 'ProdtypeName must be unique',
        },
      },
    },
    product: {
      errors: {
        unique: {
          prodName: 'ProdName must be unique',
          partNumber: 'PartNumber must be unique',
        },
      },
    },
    pRODUCTline: {
